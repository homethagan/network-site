  ...
  if (loading || !formData) {
    return (
      <div className="min-h-screen bg-[#EAEAE6]">
        <AdminSidebar />
        <div className="md:ml-64 p-4 md:p-8 pt-16 md:pt-12">
  ...
  return (
    <div className="min-h-screen bg-[#EAEAE6]">
      ...
      <div className="md:ml-64 p-4 md:p-12 pt-16 md:pt-12">
        <h1 className="font-syne font-black text-4xl md:text-5xl mb-8 md:mb-12 uppercase text-[#111] border-b-4 border-[#111] pb-6">Edit Post</h1>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div>
                ...
                <MarkdownEditor
                  ...
                  onChange={(value) => setFormData(prev => prev ? { ...prev, content: value } : null)}
                />
              </div>
            </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div>
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="font-bold text-sm uppercase text-[#111]">Published</span>
                </label>
              </div>
